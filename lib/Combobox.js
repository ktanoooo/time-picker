  ...
  (0, _createClass3['default'])(Combobox, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        this.getHourSelect((0, _dateUtils.getHours)(value)),
        this.getMinuteSelect((0, _dateUtils.getMinutes)(value)),
        this.getSecondSelect((0, _dateUtils.getSeconds)(value)),
        this.getAMPMSelect((0, _dateUtils.getHours)(value))
      );
    }
  }]);
  return Combobox;
