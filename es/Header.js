  ...
  function Header(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onInputChange", function (event) {
      ...
      if (str) {
        ...
        var value = setHours(setMinutes(setSeconds(_this.getProtoValue(), getSeconds(parsed)), getMinutes(parsed)), getHours(parsed)); // if time value not allowed, response warning.
    ...
    _this.state = {
      str: _value && formatTime(_value, _format, formatLocale) || '',
      invalid: false
    };
    return _this;
  }
